CREATE OR REPLACE VIEW osmium.loadoutssearchdata AS
 SELECT l.loadoutid,
        CASE l.visibility WHEN 1 THEN accounts.accountid ELSE (CASE l.viewpermission
            WHEN 4 THEN accounts.accountid
            ELSE 0
        END) END AS restrictedtoaccountid,
