...
if($type == 'comment') {
	$row = \Osmium\Db\fetch_assoc(\Osmium\Db\query_params('SELECT accountid, loadoutid FROM osmium.loadoutcomments WHERE commentid = $1', array($id)));
	...
	$row = \Osmium\Db\fetch_assoc(\Osmium\Db\query_params('SELECT loadoutcommentreplies.accountid, loadoutcommentreplies.commentid, loadoutid FROM osmium.loadoutcommentreplies JOIN osmium.loadoutcomments ON loadoutcomments.commentid = loadoutcommentreplies.commentid WHERE commentreplyid = $1', array($id)));
