...
echo "<li>Lossy formats: <a href='../export/{$slug}-evexml-{$loadoutid}.xml?embedclf=0' title='EVE XML'>XML</a>, <a href='../export/{$slug}-eft-{$loadoutid}.txt'>EFT</a>, <a href='../export/{$slug}-dna-{$loadoutid}.txt'>DNA</a>, <a href='javascript:CCPEVE.showFitting(\"$dna\");'>in-game DNA</a></li>\n";
echo "</ul>\n</li>\n";
