...
echo "<li>Lossless formats: <a href='../export/{$slug}-clf-{$loadoutid}.json' title='Common Loadout Format, human-readable'>CLF</a>, <a title='Common Loadout Format, minified' href='../export/{$slug}-clf-{$loadoutid}.json?minify=1'>minified CLF</a>, <a href='../export/{$slug}-md-{$loadoutid}.md' title='Markdown with embedded gzipped Common Loadout Format'>Markdown+gzCLF</a>, <a href='../export/{$slug}-evexml-{$loadoutid}.xml?{$presets}' title='EVE XML with embedded gzipped Common Loadout Format'>XML+gzCLF</a></li>\n";
echo "<li>Lossy formats: <a href='../export/{$slug}-evexml-{$loadoutid}.xml?embedclf=0&amp;{$presets}' title='EVE XML'>XML</a>, <a href='../export/{$slug}-eft-{$loadoutid}.txt?{$presets}'>EFT</a>, <a href='../export/{$slug}-dna-{$loadoutid}.txt?{$presets}'>DNA</a>, <a href='javascript:CCPEVE.showFitting(\"$dna\");'>in-game DNA</a></li>\n";
echo "</ul>\n</li>\n";
